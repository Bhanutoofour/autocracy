      ...
      <section className="site-container py-8 lg:py-16">
        <div className="grid gap-10 lg:grid-cols-[minmax(468px,1.2fr)_minmax(0,0.8fr)]">
          ...
          <div>
            ...
            <h1 className="mt-3 font-['Roboto_Condensed','Arial_Narrow',Arial,sans-serif] text-[44px] font-bold uppercase italic leading-none text-[#0a0a0b]">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {relatedModels.map((model) => (
              <article className="rounded border border-black/10 bg-white p-4" key={model.id}>
                ...
                <h3 className="mt-1 text-[24px] font-semibold leading-[1.15] text-[#0e1116]">{model.modelNumber}</h3>
