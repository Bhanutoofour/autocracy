...
const messages: Record<ContentLanguage, MessageTree> = {
  ...
  hi: {
    ...
    home: {
      ...
      strengthsHeading: "भारत के लिए निर्मित। दक्षता के लिए इंजीनियर्ड।",
      certificationsHeading: "हमारे प्रमाणपत्र",
      storiesHeading: "हमारी कहानी, उनकी जुबानी",
      happyClients: "खुश ग्राहक",
    },
    footer: {
      ctaHeading: "परफॉर्मेंस के लिए निर्मित। आपके लिए ब्रांडेड।",
      ctaBody:
    ...
    locationGate: {
      title: "कृपया अपनी लोकेशन की पुष्टि करें",
...
const uiText: Record<ContentLanguage, Record<UiKey, string>> = {
  ...
  hi: {
    ...
    no_linked_industries: "कोई लिंक्ड उद्योग नहीं मिला।",
    ...
    translation_pending_body: "यह पेज आपकी चुनी गई भाषा के लिए लोकलाइज़ किया जा रहा है।",
  },
  fr: {
    products: "Produits",
    industries: "Secteurs",
